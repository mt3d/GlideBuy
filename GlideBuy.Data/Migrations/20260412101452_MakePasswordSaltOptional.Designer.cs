...
namespace GlideBuy.Migrations
{
    ...
    [Migration("20260412101452_MakePasswordSaltOptional")]
    partial class MakePasswordSaltOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GlideBuy.Core.Domain.Catalog.ProductPicture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GlideBuy.Core.Domain.Media.Picture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GlideBuy.Core.Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<bool>("AllowStoringCreditCardInfo")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal>("PaymentMethodAttditionalFeeExclTax")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("GlideBuy.Core.Domain.Customers.CustomerPassword", b =>
                {
                    b.HasOne("GlideBuy.Core.Domain.Customers.Customer", "Customer")
                        .WithMany()
